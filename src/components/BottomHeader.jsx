...
const BottomHeader = () => {
  return (
    <div className='flex items-center justify-evenly mt-4 gap-2 absolute bottom-0 w-full bg-white p-2 border-t border-gray-200'>
      {/* Home */}
      <Link to='/' className='relative group text-gray-600 hover:text-gray-800'>
